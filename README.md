...
Solutions for the J.P. Morgan Quantitative Research Virtual Experience (Forage), including commodity pricing, storage contract valuation, credit risk analysis, and FICO score bucketing.
import os
